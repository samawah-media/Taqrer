            ...
            >
              <div className="relative rounded-[3rem] overflow-hidden border-8 border-white/10 shadow-2xl bg-black aspect-video group">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/gx-zPheFnHo?rel=0&controls=1&modestbranding=1"
                  title="Samawah Strategy"
                  frameBorder="0"
          ...
          {!isSuccess ? (
            <div className="space-y-8">
              <form onSubmit={handleSubmit} className="space-y-6 bg-gray-50 p-10 rounded-[32px] border border-gray-100 shadow-xl">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700 px-2">رقم الجوال</label>
                    <div className="relative">
                      <input
                        required
                        type="tel"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-700 px-2">الوظيفة</label>
                    <div className="relative">
                      <input
                        required
                        type="text"
